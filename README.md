...
| | *Every second, the Musician will send an UDP datagram* |
|Question | Who is going to **listen for UDP datagrams** and what should happen when a datagram is received? |
| | *The Auditor will listen for UDP datagrams and It will send us a JSON payload through TCP containing the active musicians* |
|Question | What **payload** should we put in the UDP datagrams? |
| | *The JSON payload should contains the uuid, the instrument played  and the last activity date (activeSince)* |
...
| | *It allow us to install a node js module, the --save flag is here to say to add the dependencies*
